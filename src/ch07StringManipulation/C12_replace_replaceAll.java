...
public class C12_replace_replaceAll {
    public static void main(String[] args) {
        ...
        // madem geldin dün$ otur çalış JAVA'ya :)

        System.out.println("str.replace(\"ü\",\"U\") = " + str.replace("ü", "U"));

        System.out.println("str.replace(\":)\", \"\") = " + str.replace(":)", ""));

        System.out.println("str = " + str); // str = madem geldin dünyaya otur çalış JAVA'ya :)
        str = str.replace(":)", "");
        System.out.println("str = " + str); // str = madem geldin dünyaya otur çalış JAVA'ya
        ...
        System.out.println("str.replaceAll(\"\\\\s\", \"*\") = " + str.replaceAll("\\s", "_"));
        // javaCAN'lara_selam_bolcana_123456780232_§_$_#_£_offer_:)_
        ...
        // javaCAN'lara selam bolcana ************ § $ # £ offer :)
