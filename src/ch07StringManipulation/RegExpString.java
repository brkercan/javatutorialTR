...
public class RegExpString {
    ...
    public static void main(String[] args) {
        ...
        // [^abc]    a, j08_ifStatement_TernaryOperator.b, c disinda herhangi bir karakter (negation)
        System.out.println("[^...] quantifier ....");
        ...
        System.out.println("j08_ifStatement_TernaryOperator.b".matches("[abc]?")); // false, a, b veya c en fazla 1 defa
