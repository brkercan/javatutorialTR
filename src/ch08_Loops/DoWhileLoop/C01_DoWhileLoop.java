package ch08_Loops.DoWhileLoop;
...
public class C01_DoWhileLoop {
    public static void main(String[] args) {
        ...
        int yas = 30;
        while (yas > 40) {
            System.out.println("abdullah bey "+yas+" hayırlı olsun while body execute edildi..while");
        yas++;
        }


        do{
            System.out.println("abdullah bey "+yas+" hayırlı olsun while body execute edildi..doWhile");
            yas++;
        }
        while(yas>40);
